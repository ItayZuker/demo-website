...
const AgeLimitBirthdayStage = () => {
    ...
    const getDayObject = (dateOfBirth) => {
        return new Promise(resolve => {
            ...
            switch (day1) {
                case 0:
                    resolve({string: 'Sunday', short: 'Sun', decimal: decimal});
                    break;
                case 1:
                    resolve({string: 'Monday', short: 'Mon', decimal: decimal});
                    break;
                case 2:
                    resolve({string: 'Tuesday', short: 'Tues', decimal: decimal});
                    break;
                case 3:
                    resolve({string: 'Wednesday', short: 'Wed', decimal: decimal});
                    break;
                case 4:
                    resolve({string: 'Thursday', short: 'Thurs', decimal: decimal});
                    break;
                case 5:
                    resolve({string: 'Friday', short: 'Fri', decimal: decimal});
                    break;
                case 6:
                    resolve({string: 'Saturday', short: 'Sat', decimal: decimal});
                    break;
                default:
                    resolve({string: '', short: '', decimal: null});
            }
