    ...
    return (
        <div className="drag-and-drop-container">
            <FileUploader
                ...
                onTypeError={(message) => typeError(message)}
                onSelect={(file) => selectFile(file)}
                handleChange={image => props.setImage(image)} >
                <div className="file-uploader-container">
                    ...
                    <p>Click / Drag & Drop to upload image</p>
                </div>
            </FileUploader>
        </div>
    )
