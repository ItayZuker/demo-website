...
const MyGallery = () => {
    ...
    const handleChange = (index) => {
        switch (index) {
        case 0:
            setHideArrow("first-image")
            break
        case user.images.length - 1:
            setHideArrow("last-image")
            break
        default:
            setHideArrow("")
        }
    ...
    /* JSX Output */
    return (
        <div className={"my-gallery-container " + hideArrow}>
            <div
                onClick={() => setPopup("")}
            ...
            <Carousel
                ...
                centerMode={true}
                selectedItem={action.openImageIndex}
